...
const PoiScopeSelector = () => {

  const [currentPoiScope, setCurrentPoiScope] = useState('Seoul');
  ...
  return (
    <div className="flex flex-row items-center">
      ...
      <select className="mr-3 rounded-lg p-1" name="province-selector">
      ...
      {currnetPoiScope == 'seoul' &&
        <select className="rounded-lg p-1" name="city-selector-seoul" onChange={handleChange} value={currentDistrict}>
      ...
      <select className="rounded-lg p-1" name="city-selector-gyeonggi" onChange={handleChange} value={currentDistrict}>
        <option disabled>선택하세요</option>
          <optgroup label="경기도">
            <option value="gangnam">강남구</option>
      ...
      <select className="rounded-lg p-1" name="city-selector-incheon" onChange={handleChange} value={currentDistrict}>
        <option disabled>선택하세요</option>
          <optgroup label="경기도">
            <option value="gangnam">강남구</option>
...
export default PoiScopeSelector;
