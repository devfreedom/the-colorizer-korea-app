...
const PoiDetails = ({ handleState, selectedPoi }) => {
  function handleClick() {
    // PoiPage에서의 selectedPoi 상태값을 소거해서, PlacesPage에서 POI 상세정보 컴포넌트 대신에 POI 목록 컴포넌트를 보여주도록 합니다.
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col m-7">
        ...
        <div className="ml-2">
          ...
          <p><span className="mr-2">Type:</span><span>{selectedPoiData.poi_type}</span></p>
          <p><span className="mr-2">Area:</span><span>{selectedPoiData.area}</span><span>㎡</span></p>
